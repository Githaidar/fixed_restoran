...
const Reservation = () => {
    ...
    return <div >
        <
        section className = 'relative top-48 z-30 pb-20 lg:py-[100px]' >
        <
    ...
    className = 'h2 capitalize' > { title } <
        /motion.h2> { /*subtitle*/ } <
        motion.p
    variants = { fadeIn('up', 'tween', 0.4, 1.6) }
    className = 'mb-8 text-dark' > { subtitle } <
        /motion.p> { /*model*/ } <
        motion.div
    ...
    whileInView = { 'show' } >
        <
        div className = 'flex flex-col lg:flex-row gap-y-4 items-center justify-between mb-8' > { /*datepicker*/ } <
        div >
        <
